...
engine = SearchEngine()
metadata_path = os.path.join(BASE_DIR, "metadata", "documents_metadata.json")
if os.path.exists(metadata_path):
    with open(metadata_path, "r", encoding="utf-8") as f:
        metadata = json.load(f)
else:
    metadata = {}
CLEAN_DIR = os.path.join(BASE_DIR, "processed", "clean_texts")
PDF_DIR = os.path.join(BASE_DIR, "raw", "pdf")
