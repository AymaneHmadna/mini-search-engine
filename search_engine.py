...
class SearchEngine:
    def __init__(self):
        self.w2v_model = Word2Vec.load("processed/word2vec.model")
        with open("processed/w2v_matrix.pkl", "rb") as f:
    ...
    def preprocess_query(self, query):
        ...
        clean_words = [
            w for w in words 
            if w.isalpha() and w not in self.stop_words and 1 < len(w) < 25
        ]
